...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DFPLAYER_TX_GPIO_Port, DFPLAYER_TX_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : DFPLAYER_TX_Pin */
  ...
  /*Configure GPIO pin : DFPLAYER_BUSY_Pin */
